...
struct Vectorized<c10::quint8> {
 ...
 public:
    ...
    operator vuint8m2_t() const {
        return __riscv_vle8_v_u8m2(vals, vl);
    }

    void store(void* ptr, int count = size()) const {
        vuint8m2_t vec = __riscv_vle8_v_u8m2(vals, count);
        __riscv_vse8_v_u8m2(reinterpret_cast<value_type*>(ptr), vec, count);
    }
 ...
 public:
    float_vec_return_type dequantize(
      ...
      Vectorized<float> scale_zp_premul) const {
        vuint8m2_t u8_vec = __riscv_vle8_v_u8m2(vals, vl);
        vuint64m2_t u64_vec= __riscv_vreinterpret_v_u8m2_u64m2(u8_vec);
    ...
    int_vec_return_type widening_subtract(Vectorized<c10::quint8> b) const {
        vuint8m2_t vals_u8_vec = __riscv_vle8_v_u8m2(vals, vl);
        vuint64m2_t vals_u64_vec= __riscv_vreinterpret_v_u8m2_u64m2(vals_u8_vec);
        ...
        vuint8m2_t b_u8_vec = __riscv_vle8_v_u8m2(b.vals, vl);
        vuint64m2_t b_u64_vec= __riscv_vreinterpret_v_u8m2_u64m2(b_u8_vec);
